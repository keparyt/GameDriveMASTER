...
_TITLE_ALIASES = {
    ...
    "civilization 6": "sid meier s civilization vi", "civilisation 6": "sid meier s civilization vi",
    "civilization vi": "sid meier s civilization vi", "civilisation vi": "sid meier s civilization vi",
    "civ 6": "sid meier s civilization vi", "civ vi": "sid meier s civilization vi",
    "civilization 7": "sid meier s civilization vii", "civilisation 7": "sid meier s civilization vii",
    "civilization vii": "sid meier s civilization vii", "civilisation vii": "sid meier s civilization vii",
    "civ 7": "sid meier s civilization vii", "civ vii": "sid meier s civilization vii",
    "stalker 2": "s t a l k e r 2 heart of chornobyl",
    "stalker 2 heart of chornobyl": "s t a l k e r 2 heart of chornobyl",
    "hollow knight silk song": "hollow knight silksong", "hollow knight silk songs": "hollow knight silksong",
    "hollow knight silksong": "hollow knight silksong", "rocket league": "rocket league",
    "overwatch 2": "overwatch 2", "garys mod": "garrys mod", "gary s mod": "garrys mod",
    "gmod": "garrys mod", "skyrim": "the elder scrolls v skyrim",
}
    ...
    for game in games:
        ...
        if match:
            item.update({
                ...
                "tgdb_game_id": match.tgdb_game_id,
                "selected_platform": match.selected_platform,
                "console_platforms": list(match.console_platforms),
                "console_names": list(match.console_platforms),
                "pc_available": match.pc_available,
                "has_console": bool(match.console_platforms),
            })
        else:
            item["verified"] = False
